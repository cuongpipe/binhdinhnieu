...
<head>
  <meta charset="UTF-8">
  <title>Chùa Thiên Hưng - Danh lam thắng cảnh Bình Định</title>
...
<body>
  <div class="container py-5">
    <h2 class="text-center mb-4">Chùa Thiên Hưng</h2>
    ...
    <div class="swiper mySwiper2 mb-3">
      <div class="swiper-wrapper">
        <?php
          $images = [
            "imgDanhlamthangcanh/thienhung.jpg",
            "imgDanhlamthangcanh/thienhung.jpg",
            "imgDanhlamthangcanh/thienhung.jpg",
            "imgDanhlamthangcanh/thienhung.jpg",
            "imgDanhlamthangcanh/thienhung.jpg",
  ...
  <h5>Giới thiệu</h5>
   ...
   <div class="section-box">
    <h5>Địa chỉ:</h5>
    <p>Phường Nhơn Hưng, Thị Xã An Nhơn, Tỉnh Bình Định.</p>
  </div>
  ...
  <div class="section-box">
    ...
    <p>Thành cổ Đồ Bàn, Ga Diêu Trì, Sân bay Phù Cát,...</p>
  </div>
</div>
