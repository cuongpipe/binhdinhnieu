...
<head>
  <meta charset="UTF-8">
  <title>Tháp Bánh Ít- Danh lam thắng cảnh Bình Định</title>
...
<body>
  <div class="container py-5">
    <h2 class="text-center mb-4">Tháp Bánh Ít</h2>
    ...
    <div class="swiper mySwiper2 mb-3">
      <div class="swiper-wrapper">
        <?php
          $images = [
            "imgDanhlamthangcanh/thapbanhit.jpg",
            "imgDanhlamthangcanh/thapbanhit.jpg",
            "imgDanhlamthangcanh/thapbanhit.jpg",
            "imgDanhlamthangcanh/thapbanhit.jpg",
            "imgDanhlamthangcanh/thapbanhit.jpg",
          ...
          foreach ($images as $img) {
            echo "<div class='swiper-slide'><img src='$img' alt='Tháp Bánh Ít'></div>";
          }
        ?>
      </div>
